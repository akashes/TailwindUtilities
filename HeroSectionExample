...
import image from '../../assets/hero-Dv8sjFKx.png'
import { FaPlay } from "react-icons/fa";
import {motion} from 'framer-motion'
import { SlideRight } from "../../utility/animation";
const Hero = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative md:px-24 ">
      {/* brand info */}
    <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0 " >
        <div  className="text-center md:text-left space-y-6 ">
            <motion.p 
            variants={SlideRight(.4)} 
            initial="hidden"
            animate="visible"
      ...
      <div className="flex justify-center items-center">
        ...
        transition={{type:"spring",stiffness:100,delay:.3,duration:.5}}
        src={image} alt="" className="w-[350px] md:w-[550px] xl:w-[700px]" />
      </div>
    </div>
  );
};
